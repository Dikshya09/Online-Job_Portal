...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (count($err) == 0) {
        ...
        $stmt = $connection->prepare("SELECT * FROM jobseeker WHERE jobseeker_email = ? AND password = ?");
        ...
        if ($result->num_rows > 0) {
            ...
            header("Location: jobseekerheader.php"); // Redirect to dashboard
...
<body>
    ...
    <section class="form-box">
        <form action="" method="post" name="login_form">
            ...
            <?php if (isset($err['authentication'])) echo "<p class='error-message'>{$err['authentication']}</p>"; ?>
            <div class="btn-group">

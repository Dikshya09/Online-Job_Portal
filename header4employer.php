...
$stmt = $mysqli->prepare("SELECT c_name,  c_image FROM company WHERE c_email = ?");
...
<body>
    ...
    <div class="header1">
        <nav>
            ...
            <div class="nav-links">
                <ul>
                    <li><a href="empdashboard.php?page=postedjob" >Jobs</a></li>
                    <li><a href="empdashboard.php?page=applicant" >Application</a></li>
                    <li><a href="empdashboard.php?page=job_post" >Open Position</a></li>
                </ul>
            </div>
